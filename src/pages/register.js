...
export default function Register() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen">
            <form className="p-6 bg-gray-100 rounded shadow-md" onSubmit={handleRegister}>
                <div>
                ...
                <div className="mt-4">
                <p className="text-center text-sm text-gray-600">Ya tienes cuenta? <Link className="text-blue-500 hover:text-blue-700" href="/login">Login</Link></p>
            </div>
            </form>
        </div>
    );
